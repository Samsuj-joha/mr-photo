...
const BookPage = () => {
  ...
  const getTagColorClass = (color: string) => {
    ...
    return colorMap[color] || "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300"
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-medium text-foreground mb-4">No Books Available</h1>
          <p className="text-muted-foreground">{error || "No books have been published yet."}</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="bg-background py-8 min-h-screen">
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-6xl font-black text-foreground mb-8 tracking-tighter leading-none">
          Life Through <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 dark:from-blue-400 dark:via-purple-400 dark:to-blue-600">The Lens</span>
        </h1>

        <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed font-light">
          An extraordinary visual odyssey through the masterful photography of 
          <span className="text-blue-600 dark:text-blue-400 font-semibold"> Moshiur Rahman</span>
        </p>
      </div>
            ...
            <div key={book.id} className="group relative">
              {book.pdfUrl ? (
                <a href={getPdfViewerUrl(book.pdfUrl)} target="_blank" rel="noopener noreferrer">
                  <div className="relative bg-card overflow-hidden shadow-xl border border-border hover:shadow-2xl transition-all duration-300">
                    ...
                    {/* Book Details */}
                    <div className="p-6 h-[200px] flex flex-col bg-card">
                      <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex items-center text-card-foreground font-semibold group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                          <span>Read Now</span>
                          <ArrowRight size={18} className="ml-2 group-hover:translate-x-1 transition-transform" />
                        </div>
                      </div>

                      <p className="text-muted-foreground leading-snug mb-4 flex-grow text-sm">
                        {book.description}
                      </p>
                ...
                <div className="relative bg-card overflow-hidden shadow-xl border border-border opacity-75">
